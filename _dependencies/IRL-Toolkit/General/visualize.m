...
subplot(1,2,1);
title('Ground Truth');
feval(strcat(test_result.mdp,'draw'), test_result.true_r, test_result.mdp_solution.p, g, test_result.mdp_params, test_result.mdp_data);

% Draw reward for IRL result.
subplot(1,2,2);
title('Learned Reward');
feval(strcat(test_result.mdp,'draw'), test_result.irl_result.r, test_result.irl_result.p, g, test_result.mdp_params, test_result.mdp_data);
